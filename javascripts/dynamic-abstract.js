document.querySelectorAll(".abstract").forEach((elem) =>
  elem.addEventListener("click", (e) => {
    ...
    <p><small>Draft link: <a href=""> ... </a></small></p>
    <br>
    <p> <strong> Abstract: </strong> Transitioning from fossil fuel to biofuel is a key strategy for reducing GHG emissions in energy-intensive sectors. While existing research has delved into how taxes, mandates, and other public interventions encourage this transition and stimulate cost-reducing innovations in biofuel production, the study of innovations aimed specifically at reducing biofuel emissions remains scant. Addressing this gap, our paper explores the impact of public interventions on the adoption of these emission-reducing innovations within the biofuel production. Through a model where an innovator markets such innovations to an industry which produces and blends biofuel with fossil fuel, we unveil how quota-based interventions fail to incentivize the industry towards adopting these innovations. Intriguingly, we then find that while an emission tax encourages the adoption of significant emission-reducing innovations, emission standards paradoxically favor only innovations yielding marginal improvements. Finally, we analyze the innovator's pricing strategy and its surplus sharing.  Our findings not only challenge conventional wisdom but also offers nuanced insights for policymakers aiming to refine regulatory measures to maximize the environmental benefits of biofuel innovation.</p>
    <a href="./index.html"> [Back] </a>
    `;
